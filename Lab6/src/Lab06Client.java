...
/**
 * The class <code>Lab06Client</code> provides practice with using some of the
 * interfaces and classes of the Java Collection Framework.
 *
...
public class Lab06Client {
	...
	/**
	 * The first method typically executed within a Lab06Client object. This method
	 * calls helper methods to practice using some of the interfaces (that is,
	 * abstract data types) in the Java Collection Framework.
	 */
	private void useJCF() {
	...
	/**
	 * A client for the ArrayList collection interface that has the element in the
	 * collection being of type String.
	 */
	...
	/**
	 * A client for the ArrayList collection interface that has the element in the
	 * collection being of type Classification.
	 */
	private void useArrayListClassificationElement() {
		ArrayList<Classification> list02;
		list02 = new ArrayList<Classification>();
		...
		Classification c = new Classification("Homo", "sapiens");
		list02.add(c);

		// add a Classification element with genus "Homo" and species "sapiens"

		Classification c2 = new Classification("Malus", "domestica");
		list02.add(c2);
	...
	/**
	 * Provides the entry point for this application. This method creates a
	 * <code>Lab06Client</code> and executes the useJCF() method.
	 *
	 * @param args
	 *            Unused.
	 */
